...
bufferBeforeReturnMouse := 1

; The buffer time before the script detect and simulate the next move, in milliseconds. The higher this value, the higher the xDistance and yDistance you should set above.
bufferBeforeNextDetect := 0
